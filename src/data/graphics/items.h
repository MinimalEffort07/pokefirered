...
// Placeholder: reuses the Itemfinder icon until a dedicated PokeRadar sprite lands.
const u32 gItemIcon_PokeRadar[] = INCBIN_U32("graphics/items/icons/itemfinder.4bpp.lz");
const u32 gItemIconPalette_PokeRadar[] = INCBIN_U32("graphics/items/icon_palettes/itemfinder.gbapal.lz");
